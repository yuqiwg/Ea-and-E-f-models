...
# Separate the dataset into training and test sets
        ...
        np.save('../../data/E_and_f/f_%s_trainx_%s' % (name,spe),locals()['X_train_%s' % spe])
        np.save('../../data/E_and_f/f_%s_testx_%s' % (name,spe),locals()['X_test_%s' % spe])
        np.save('../../data/E_and_f/f_%s_trainy_%s' % (name,spe),locals()['y_train_%s' % spe])
        np.save('../../data/E_and_f/f_%s_testy_%s' % (name,spe),locals()['y_test_%s' % spe])
